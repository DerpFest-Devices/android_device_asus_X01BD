git clone git@github.com:ArrowOS-Devices/android_device_asus_sdm660-common.git -b arrow-12.1 device/asus/sdm660-common
...
git clone git@github.com:PixelExperience/packages_apps_TouchGestures.git -b twelve packages/apps/TouchGestures
